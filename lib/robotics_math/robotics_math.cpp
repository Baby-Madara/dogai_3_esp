...
void GaitManager::publishing_routine(float xyz_cmd_array[4][3])
{
    ...
    for (int i = 0; i < 4; ++i) {
        auto result = compound_bezier(
            ...
            0.2,                            // float swing_curving_to_ssq_ratio = 1
            0.0,                            // float penetration_depth = 0
            legs_thetas[i],                 // float rotation_angle = 0
            true,                           // bool smooth = false
            "old"                           // String version = "old"
        );
        // auto result = compound_bezier(  
        //     t,                      // t
        //     total_step_time,        // total_step_time
        //     legs_speeds[i],         // speed
        //     0.88,                   // stance_ratio = 0.85
